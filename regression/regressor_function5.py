...
N = 200
np.random.seed(3)
X_all = np.random.randn(N, 3)
y_all = np.exp(X_all[:,0]*X_all[:,1]*X_all[:,2])
...
#%%
print("1/3 Generate Delaunay Triangularization")
