...
XA = np.loadtxt("Train_TwoCurlySpirals_A.txt",  delimiter=' ')

XB = np.loadtxt("Train_TwoCurlySpirals_B.txt",  delimiter=' ')
...
XA1 = np.loadtxt("Train_TwoCurlySpirals_1_A.txt",  delimiter=' ')

XB1 = np.loadtxt("Train_TwoCurlySpirals_1_B.txt",  delimiter=' ')
...
XtestA = np.loadtxt("Test_TwoCurlySpirals_A.txt",  delimiter=' ')

XtestB = np.loadtxt("Test_TwoCurlySpirals_B.txt",  delimiter=' ')
