...
Train_RingSpiral_A = Points_A;
Train_RingSpiral_B = Points_B;


dlmwrite('Train_RingSpiral_A.txt', Train_RingSpiral_A, 'delimiter',' ')
dlmwrite('Train_RingSpiral_B.txt', Train_RingSpiral_B, 'delimiter',' ')
