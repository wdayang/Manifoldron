...
Test_RingSpiral_A = Points_A;
Test_RingSpiral_B = Points_B;


dlmwrite('Test_RingSpiral_A.txt', Test_RingSpiral_A, 'delimiter',' ')
dlmwrite('Test_RingSpiral_B.txt', Test_RingSpiral_B, 'delimiter',' ')
