...
scatter3(Train_Circle_A(:,1),Train_Circle_A(:,2),Train_Circle_A(:,3),30, 'filled')
hold on

scatter3(Train_Circle_B(:,1),Train_Circle_B(:,2),Train_Circle_B(:,3),30, 'filled')
...
%%
Test_Circle_A = Points_A;
Test_Circle_B = Points_B;

dlmwrite('Test_Circle_A.txt', Test_Circle_A, 'delimiter',' ')
dlmwrite('Test_Circle_B.txt', Test_Circle_B, 'delimiter',' ')
