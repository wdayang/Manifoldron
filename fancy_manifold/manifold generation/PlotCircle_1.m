...
Train_Circle_1_A = Points_A;
Train_Circle_1_B = Points_B;


dlmwrite('Train_Circle_1_A.txt', Train_Circle_1_A, 'delimiter',' ')
dlmwrite('Train_Circle_1_B.txt', Train_Circle_1_B, 'delimiter',' ')
