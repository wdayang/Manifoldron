...
%%
Test_TwoCurlySpirals_A = Points_A;
Test_TwoCurlySpirals_B = Points_B;


dlmwrite('Test_TwoCurlySpirals_A.txt', Test_TwoCurlySpirals_A, 'delimiter',' ')
dlmwrite('Test_TwoCurlySpirals_B.txt', Test_TwoCurlySpirals_B, 'delimiter',' ')
