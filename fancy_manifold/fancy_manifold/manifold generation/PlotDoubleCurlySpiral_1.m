...
%%
Train_TwoCurlySpirals_1_A = Points_A;
Train_TwoCurlySpirals_1_B = Points_B;


dlmwrite('Train_TwoCurlySpirals_1_A.txt', Train_TwoCurlySpirals_1_A, 'delimiter',' ')
dlmwrite('Train_TwoCurlySpirals_1_B.txt', Train_TwoCurlySpirals_1_B, 'delimiter',' ')
