...
XA = np.loadtxt("Train_Circle_A.txt",  delimiter=' ')

XB = np.loadtxt("Train_Circle_B.txt",  delimiter=' ')
...
XA1 = np.loadtxt("Train_Circle_1_A.txt",  delimiter=' ')

XB1 = np.loadtxt("Train_Circle_1_B.txt",  delimiter=' ')
...
XtestA = np.loadtxt("Test_Circle_A.txt",  delimiter=' ')

XtestB = np.loadtxt("Test_Circle_B.txt",  delimiter=' ')
